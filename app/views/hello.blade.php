		...
		<div class="container top-block">
			<div class="row">
				...
				<div class="col-sm-7 col-xs-12 ">
					<div class="row">			
						<p class="text-right block-contact"> 
							<a href="">+9(495)3216547</a> 
							<br>Написать письмо
						</p>
					</div>
					<div class="row">
						<nav class="navbar ">
						    ...
						    <div class="collapse navbar-collapse" id="navbar-main-menu">
						      <ul class="nav navbar-nav navbar-right">
						        ...
						        <li><a href="#we-service">Женская Коллекция</a></li>
						        <li><a href="#advantage">Детский ассортимент</a></li>
						        <li><a href="#scheme-work">Советы</a></li>
						        <li><a href="#unique-offer">Нашим клиентам</a></li>
						      </ul>
						    </div><!-- /.navbar-collapse -->
						</nav>						
					</div>
